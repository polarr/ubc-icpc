...
<section class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
	<Card.Root class="flex w-[350px] flex-col justify-between">
		<Card.Header>
			...
			<Card.Description>
				Create extensively customizable multiplayer mocks on the Virtual Olympiad Arena (VOA). Play
				in Free-for-all or Team formats with lobbies up to 16 people.
			</Card.Description>
		</Card.Header>
		<Card.Content>
			<Card.Root>
					...
					<div class="grid gap-4">
						<div class="flex items-center gap-4">
							...
							<div class="grid gap-1">
								<p class="text-sm leading-none font-medium">Mango</p>
								<p class="text-muted-foreground text-sm">@polarity</p>
							</div>
						...
						<div class="flex items-center gap-4">
							...
							<div class="grid gap-1">
								<p class="text-sm leading-none font-medium">Orz Person</p>
								<p class="text-muted-foreground text-sm">@orz</p>
							</div>
	...
	<Card.Root class="flex w-[350px] flex-col justify-between">
		<Card.Header>
			...
			<Card.Description
				...
				tags, difficulty, sources, etc. AMC, IPhO, Classics; you name it, Virtual Olympiad Database
				(VODB) probably has it.</Card.Description
			>
		</Card.Header>
		<Card.Content>
			<Card.Root>
				<Card.Header>
					...
					<div class="grid grid-cols-2 items-center gap-4 space-y-0">
						<div>
						...
						>
							...
							<DropdownMenu.Root>
								<DropdownMenu.Trigger class="hover:cursor-pointer">
									<ChevronDown class="text-secondary-foreground h-4 w-4 mx-2 shrink-0" />
		...
		<Card.Footer class="flex justify-between">
			<Button
				target="_blank"
				rel="noreferrer"
				href={config.links.vodb + '/contribute'}
				variant="outline">Contribute</Button
			>
	...
	<Card.Root class="flex w-[350px] flex-col justify-between">
		<Card.Header>
			...
			<Card.Description
				>Track your problem-solving journey and progress efficiently with the Virtual Olympiad Judge
				(VOJ).
			</Card.Description>
		</Card.Header>
		<Card.Content>
			...
			>
				...
				<Card.Content>
					...
					<p class="text-muted-foreground text-xs">+4 from last week</p>
							...
							<Tooltip.Root>
								<Tooltip.Trigger
									><Button variant="ghost" class="flex w-full items-center justify-start px-2">
										<Hash class="text-secondary-foreground h-4 w-4" />
